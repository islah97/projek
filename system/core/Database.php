...
$db_config = [
    ...
    //Localhost
    "development" => [
                        "host" => getenv('local.hostname'),
                        "database" => getenv('local.db'),
                        "username" => getenv('local.username'),
                        "password" => getenv('local.password'),
                        "charset" => getenv('local.charset'),
                        "port" => getenv('local.port'),
                        "socket" => getenv('local.socket')
                     ],

    // Testing
    "staging"  =>   [
                        "host" => getenv('test.hostname'),
                        "database" => getenv('test.db'),
                        "username" => getenv('test.username'),
                        "password" => getenv('test.password'),
                        "charset" => getenv('test.charset'),
                        "port" => getenv('test.port'),
                        "socket" => getenv('test.socket')
                    ],
    //Server
    "production"  => [
                        "host" => getenv('server.hostname'),
                        "database" => getenv('server.db'),
                        "username" => getenv('server.username'),
                        "password" => getenv('server.password'),
                        "charset" => getenv('server.charset'),
                        "port" => getenv('server.port'),
                        "socket" => getenv('server.socket')
                     ]
];
