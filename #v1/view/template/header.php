  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo">
		  <!-- logo-->
		  <div class="logo-lg">
			  <span class="light-logo"><img src="<?= assets_url; ?>images/MBK2.png" alt="logo" ></span>
			  <span class="dark-logo"><img src="<?= assets_url; ?>images/logo-light-text.png" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
