<!-- Content Header (Page header) -->
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="titleModal">Penilaian Permohonan</h5>
            ...
            <form id="formData" method="POST">
              ...
              <div class="modal-body">
                ...
                <div class="col-md-12">
                   ...
                   <input type="date" name="reservation_date_pickup" id="reservation_date_pickup" class="form-control" readonly="" required>
                </div>

                <div class="form-group">
                  <label> Penerangan <span class="text-danger"> * </span> </label>
                  <textarea name="reservation_description" id="reservation_description" class="form-control" rows="4" placeholder="Sila isi penerangan.." readonly=""></textarea> 
                </div>
               ...
               <div class="modal-footer text-center">
                <center>
                   <input type="hidden" name="reservation_id" id="reservation_id" placeholder="reservation_id">
  ...
  <script type="text/javascript">
              ...
              $.ajax({
                ...
                success: function(data) {
                  for (var i = 0; i < data.length; i++) {
                   ...
                   var status = '';
                   if(data[i]['status'] == 1) {
                    status = '<span class="badge badge-info cc_cursor"> Dalam Proses </span>'
                   }
      ...
      function updateData(id){
        ...
        $('#titleModal').html('Penilaian Permohonan');
        $('#typeForm').val('approve');
        ...
        $.ajax({
                  ...
                  dataType: "JSON",
                  data: {id:id},
                  url: 'reservation/getApproveData',
                  success: function(data) {
                    $('#name').val(data['reservation'].user_name);
                    $('#staffno').val(data['reservation'].user_staff_id);
                    $('#reservation_description').val(data['reservation'].reservation_description);
                    $('#reservation_date_pickup').val(data['reservation'].reservation_date_pickup);
                    // $('#type_id').val(data['item'].equipment_type_id);

                    for (var i = 0; i < data['item'].length; i++) {
                      getListEquipment(data['item'][i]['master_equipment_id'], data['item'][i]['item_id']);
                    }
                  },
                });
      }

      function getListEquipment(id, item_id){
      ...
      $('#formData').on('submit', function(event) {
          ...
          $.ajax({
              ...
              success: function(response) {
                  ...
                  } else if (response.type == 'approve' && response.resCode == 200) {
                    toastr.success("Permohonan Telah Diproses.");
                  } else {
