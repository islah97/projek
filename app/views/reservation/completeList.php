    ...
    <div class="content-header">
      ...
      <div class="col-md-4 col-8">
        <div class="box box-body bg-success">
          <h6 class="text-uppercase">JUMLAH SELESAI</h6>
          ...
          <div class="table-responsive">
            ...
            <thead>
              <tr style="background-color: #A7DCFF;color: white">
                ...
                <th width="15%">Tarikh/Masa Pulang</th>
              ...
              $.ajax({
                ...
                success: function(data) {
                  for (var i = 0; i < data.length; i++) {
                   ...
                   var status = '';
                   if(data[i]['status'] == 4) {
                    status = '<span class="badge badge-success cc_cursor"> Selesai </span>'
                   }
                    ...
                    table.row.add([
                      ...
                      data[i]['staffNo'],
                      data[i]['date'],
                      data[i]['date_return'] + " <br> " + data[i]['time_return'],
                      data[i]['item'],
      ...
      // }
        ...
        $.ajax({
                  ...
                  success: function(data) {
                    ...
                    $('#reservation_date_return').val(data.reservation_date_return);
                    $('#reservation_time_return').val(data.reservation_time_return);
                  },
                });
      }
