...
<body>
  ...
  <div class="error">
    ...
    <div class="error__subtitle">Hmmm... Are you lost ? </div>
    <div class="error__description">Page Not Found !</div>
    <!-- <br> -->
    <a href="<?= base_url; ?>auth" class="error__button error__button--active" style="margin-top: 15px"> LOGIN </a>
    <button class="error__button" onclick="history.back()">PREVIOUS PAGE</button>
  </div>
